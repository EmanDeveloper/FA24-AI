def chatbot():
    ...
    while True:
        user_input = input("You: ").lower().split()  # Split the user input into words

        if set(user_input) & {"exit", "quit"}:  # Check if any word matches 'exit' or 'quit'
        ...
        for item in responses:
            if set(user_input) & item["question"]:  # Check if any word matches a question keyword
